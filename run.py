...
twitch_miner = TwitchChannelPointsMiner(
    username=os.environ.get('miireelita'),
    password=os.environ.get('@Benito27-12.'),           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1258435703604379669/zVx8JosGVdQOAUwrgKTZBugXY7aI0Ac4Kl_eiVfwVcV5LTcjvRg9lqLurTSLpXtBy48s",  # Discord Webhook URL
            events=[Events.BET_WIN, Events.BET_LOSE,
    ...
    streamer_settings=StreamerSettings(
        ...
        bet=BetSettings(
            ...
            max_points=100000,                   # If the x percentage of your channel points is gt bet_max_points set this value
...
twitch_miner.mine(
    [
        "shadowoski",  # Añade aquí el nombre del streamer con mayor prioridad
        "soez3",  # Añade aquí el nombre del streamer con segunda mayor prioridad
        "kiwasn",  # Y así sucesivamente
        "alexis11ninja",
        "deme",
        "zkevsh",
        "vcassieee",
    ...
    followers=True,
    blacklist=[
        "suigei_kv",  # Añade aquí el nombre del usuario a ser blacklisted
        "sawa",  # Añade aquí el nombre del usuario a ser blacklisted
        "ezeseveri",  # Y así sucesivamente
        "mamykka",
        "dr7coo",
        "theakaleina",
        "kiravtgames",
