...
twitch_miner = TwitchChannelPointsMiner(
    username="miireelita",
    password="@Benito27-12.",           # If no password will be provided, the script will ask interactively
...
twitch_miner.mine(
    ...
    followers=True, 
    blacklist=["beau194448", "raketadlo70", "ciehoev", "rexajea", "qufyracik","aceasin","michellesadaf","safiro01","vickypalami","zilvyvt","ir9ne","michellesadaf","ferdy_val","nediavr","zayiro","bysotito","yanya__","lolztehtroll","artsyvrc","raninhyung","darthomightvt","isnedd","nixprinces","julinhazsz","alexavr","hopeluss","shadowoski","fps_shina","jouffa","katyma12","rusjustthat","wolverdash_sup","valorant_la","minigodcs","valkie_","gingamy","xeawee","aeriytheneko","matty_ow","dr7coo","meguwu_vr","sawa","suigei_kv","vaxelleart","yoladragonuwu","estefania","kiuwt","maaakky","elizabeth_vt","lilycarries","1leaff","itsblot","neet","kiravtgames"],
